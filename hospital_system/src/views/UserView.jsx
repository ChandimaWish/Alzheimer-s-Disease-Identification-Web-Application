...
function UserView() {
                ...
                const tempArray = res.data.map((row) => [
                    ...
                    <div>
                        <button type="button" className="btn btn-sm  btn-success mr-3"
                                onClick={() => handleUpdate(row.id, row.user.role.role)}>
                            <i className="fa-solid fa-wrench"></i></button>
                        <button type="button" className="btn btn-sm  btn-danger"
                                onClick={() => handleDeleteDoctor(row.id, row.user.role.role)}>
    ...
    const handleTextSearch = (event) =>{
        ...
        axios.get(`${BASE_URL}/api/v2/search/filter?query=${searchText}`, AuthConfig())
            .then((res) => {
                const tempArray = res.data.map((row) => [
                    row.id,
                    row.user.email,
    ...
    return (
        <>
            <Container fluid>
                ...
                <div>
                    <button type="button" id="doctormodalopenbtn" className="btn btn-primary mr-3" data-toggle="modal"
                            data-target="#doctormodal">
                        <i className="fa-solid fa-user-doctor mr-3"></i> ADD NEW DOCTOR
                    </button>

                    <button type="button" id="patientmodalopenbtn" className="btn btn-primary mr-3" data-toggle="modal"
                            data-target="#patientmodal">
                        <i className="fa-solid fa-person-walking-with-cane mr-3"></i> ADD NEW PATIENT
                    </button>

                    <button type="button" id="adminmodalopenbtn" className="btn btn-primary mr-3" data-toggle="modal"
                        ...
                        <div className={`col-6`}>
                            <div className="form-inline">
                                <div className="form-group mx-sm-3 mb-2 w-75">
                                    <input className="form-control form-control-sm w-100" type="text" onChange={searchTextHandler} value={searchText}
                                           placeholder="search"></input>
                                </div>
                                <button type="submit" className="btn btn-sm btn-primary mb-2" onClick={handleTextSearch}><i
                            ...
                            <form onSubmit={handleDoctorSAveForm}>
                                ...
                                {!updateForm && (
                                    <div className="modal-footer">
                                        <button type="reset" onClick={handleDoctorReset} className="btn btn-secondary"
                                                data-dismiss="modal">
                                            Close
                                        </button>
            ...
            <div className="modal fade" id="patientmodal" style={{maxHeight: "90vh"}} tabIndex="-1"
                 aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handlePatientSaveForm}>
                                ...
                                {!updateForm && (
                                    <div className="modal-footer">
                                        <button type="reset" onClick={handlePatientReset} className="btn btn-secondary"
                                                data-dismiss="modal">
                                            Close
                                        </button>
                                        <button type="submit" className="btn btn-primary">
            ...
            <div className="modal fade" id="adminmodal" style={{maxHeight: "90vh"}} tabIndex="-1"
                 aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleAdminSaveForm}>
                                ...
                                {!updateForm && (
                                    <div className="modal-footer">
                                        <button type="reset" onClick={handleAdminReset} className="btn btn-secondary"
                                                data-dismiss="modal">
                                            Close
                                        </button>
                                        <button type="submit" className="btn btn-primary">
